...
<head>
    ...
    <link rel="stylesheet" href="../css/estilos_datos_pago_pse.css">
...
<body>
    ...
    <form  action="../logica/datosPago/controladorDatosPago.php" method="POST"  name="datosPagoForm" id="datosPagoForm" class="main_container">
        <div class="container-information">
            ...
            <input type="text" id="monto" name="monto" onkeyup="this.value = agregarSeparadorMiles(this.value)" required>            
        </div>
